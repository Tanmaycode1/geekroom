...
function Footer() {
  return (
    <div className="d-flex flex-column h-100 main footer">
      {/* FOOTER */}
      <footer className="w-100 py-4 flex-shrink-0">
        <div className="container py-4 px-3"> {/* Added px-3 for padding */}
          <div className="row gy-4 gx-5 row1">
            {/* First half */}
            <div className="col-lg-6 col-md-6">
              <h5 className="fs-1 text-white heading">GEEK ROOM</h5>
              <p className="small text-white heading">LEARN. CONNECT. GROW.</p>
            </div>
            {/* Second half */}
            <div className="col-lg-6 col-md-6">
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li style={{ display: 'flex', alignItems: 'center'}}>
                      ...
                      <a href="https://www.instagram.com/_geek.room/" className="footer-link p-2">
                      ...
                      <a href="https://twitter.com/geek__room_" className="footer-link p-2">
                      ...
                      <a href="https://linktr.ee/geekroom" className="footer-link p-2">
